...
import logo from '../assets/360_F_261902858_onbxqSHf193X4w7e8fdRH8vjjoT3vOVZ.jpg'; 
    ...
    return (
        <header className="bg-blue-500 text-white p-4 md:p-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <nav className="flex flex-col md:flex-row items-center mt-4 md:mt-0">
                <NavLink to="/cities" className="text-base md:text-lg mx-2 md:mx-4 hover:underline">Cities</NavLink>
                <NavLink to="#" className="text-base md:text-lg mx-2 md:mx-4 hover:underline">About</NavLink>
                <NavLink to="#" className="text-base md:text-lg mx-2 md:mx-4 hover:underline">Contact</NavLink>
