...
export default function CTA() {
  return (
    <div className="relative w-full h-screen overflow-hidden">
      <div className="absolute w-full h-full bg-cover bg-center bg-[url('https://tse1.mm.bing.net/th?id=OIG4.cSwZrYZV1WRy3aCCEhih&pid=ImgGn')] animate-zoom-out"></div>
      <div className="bg-black bg-opacity-50 w-full h-full flex items-center justify-center p-4 sm:p-8 md:p-12">
        <section className="text-center bg-black bg-opacity-60 p-4 rounded-lg sm:w-2/3 md:w-1/2 lg:w-1/3 z-50">
