...
export default function Card({ city }) {
  ...
  return (
    <>
      <div className='cards-container flex-wrap overflow-x-auto p-2'>
        <div className="card w-64 h-96 bg-gray-900 rounded-lg shadow-lg hover:scale-105 transition-transform hover:bg-gradient-to-br hover:from-blue-600 hover:to-green-600 hover:text-white m-4 flex-shrink-0">
          {loading ? (
